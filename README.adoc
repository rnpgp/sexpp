...
The `sexp-cli` command-line utility is reference parser and generator of S-expressions.
...
[source,sh]
----
sexp-cli -o certificate.dat -p -b
> Input:
> (aa bb (cc dd))
>
...
[source,sh]
----
sexp-cli -i certificate.dat -a -b -c -p -w 0
...
>
> Canonical output:
> (3:abc3:def(3:zxc3:vbn))
> Base64 (of canonical) output:
> {KDM6YWJjMzpkZWYoMzp6eGMzOnZibikp}
> Advanced transport output:
> (abc def (zxc vbn))
>
> Input:
